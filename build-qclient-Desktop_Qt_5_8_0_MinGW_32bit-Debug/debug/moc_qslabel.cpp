...
const QMetaObject QSLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_QSLabel.data,
      qt_meta_data_QSLabel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QSLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QSLabel.stringdata0))
        return static_cast<void*>(const_cast< QSLabel*>(this));
