...
QT_MOC_LITERAL(3, 24, 15) // "sig_clickChange"
    ...
    "Cell_Main\0sig_clickAdd\0\0sig_clickChange"
};
...
void Cell_Main::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Cell_Main *_t = static_cast<Cell_Main *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (Cell_Main::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Cell_Main::sig_clickAdd)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Cell_Main::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Cell_Main::sig_clickChange)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Cell_Main::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Cell_Main.data,
      qt_meta_data_Cell_Main,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Cell_Main::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Cell_Main.stringdata0))
        return static_cast<void*>(const_cast< Cell_Main*>(this));
